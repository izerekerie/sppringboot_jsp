...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).directModelSubstitute(LocalDate.class, Date.class)
                ...
                }).select().apis(RequestHandlerSelectors.basePackage("com.example.school_management_system.controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("SMS Endpoints ").description("APIs Documentation")
                .termsOfServiceUrl("https://github.com/izereuwonkunda")
                .version("1.0").build();
    }
